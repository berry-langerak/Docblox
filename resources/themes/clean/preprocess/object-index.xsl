...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="/">
    ...
    <ul id="namespaces-" class="docblox-list">
    ...
    <h1>Packages</h1>
    <ul id="packages-" class="docblox-list">
  ...
  <xsl:template match="file">
    ...
    <ul id="files_{$file}" class="docblox-list">
  ...
  <xsl:template match="package">
    <li class="package closed">
      ...
      <ul id="packages_{$package}" class="docblox-list">
        ...
        <xsl:for-each select="subpackage">
          ...
          <ul id="packages_{$package}_{$subpackage}" class="docblox-list">
